...
def test_stage3b2_final_only_selects_exactly_final() -> None:
    assert parse_deco_cache_spec("final_only", MODULES) == ["dec_net.final_layer"]


def test_stage3b2_decoder_no_final_excludes_final() -> None:
...
def test_stage3b2_plus_final_specs_include_final() -> None:
...
def test_stage3b2_all_candidates_and_no_final_specs() -> None:
...
def test_stage3b2_late_backbone_specs_parse_n() -> None:
...
def test_stage3b2_invalid_specs_raise() -> None:
