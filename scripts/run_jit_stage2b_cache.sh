...
LOG="${ROOT}/logs/stage2b/jit_stage2b_cache_stdout.log"
exec > >(tee "${LOG}") 2>&1

echo "Stage 2B JiT timestep-window block cache"
...
export PFC_STAGE2B_CACHE_INTERVAL="${PFC_STAGE2B_CACHE_INTERVAL:-2}"
export PFC_STAGE2B_CACHE_LAYERS="${PFC_STAGE2B_CACHE_LAYERS:-all}"
export PFC_STAGE2B_ACTIVE_T_MIN="${PFC_STAGE2B_ACTIVE_T_MIN:-0.1}"
export PFC_STAGE2B_ACTIVE_T_MAX="${PFC_STAGE2B_ACTIVE_T_MAX:-0.8}"
...
CMD=(python scripts/run_jit_stage2b_cache.py)
