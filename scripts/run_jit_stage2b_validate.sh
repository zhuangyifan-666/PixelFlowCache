...
LOG="${ROOT}/logs/stage2b/jit_stage2b_validate_stdout.log"
exec > >(tee "${LOG}") 2>&1

echo "Stage 2B JiT validation"
...
CMD=(python scripts/run_jit_stage2b_validate.py)
